...
public class UploadTable extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_table);

        upload_table = findViewById(R.id.table_image);
        progressBar = findViewById(R.id.progressBarTable);
        btn_table= findViewById(R.id.table_continue);

        phone = getIntent().getStringExtra("phone");

        upload_table.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        skip = findViewById(R.id.table_skip);

        skip.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(),UploadChair.class);
        ...
        btn_table.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Bitmap image = ((BitmapDrawable) upload_table.getDrawable()).getBitmap();
                new UploadTable.UploadImage(image,"table", phone).execute();
            }
        });
    }
    ...
    protected void onActivityResult (int requestCode, int resultCode, Intent data){
        ...
        if(requestCode == Img_Request && resultCode == RESULT_OK && data != null){
            ...
            try {
                ...
                upload_table.setImageBitmap(photo);
            } catch (IOException e) {
                Toast.makeText(UploadTable.this, e.toString(), Toast.LENGTH_SHORT).show();
                e.printStackTrace();
            }
        }
    ...
    private  class UploadImage extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            Toast.makeText(UploadTable.this, "Image Uploaded", Toast.LENGTH_SHORT).show();
