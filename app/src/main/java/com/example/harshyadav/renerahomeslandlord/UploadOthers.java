...
public class UploadOthers extends AppCompatActivity {

    ImageView upload_other;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_others);

        upload_other= findViewById(R.id.other_image);
        btn_other= findViewById(R.id.other_continue);
        progressBar = findViewById(R.id.progressBarOthers);
        ...
        skip = findViewById(R.id.other_skip);
        ...
        btn_other.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Bitmap image = ((BitmapDrawable) upload_other.getDrawable()).getBitmap();
                new UploadOthers.UploadImage(image,"other", phone).execute();
            }
        });
    }
    @Override
    protected void onActivityResult (int requestCode, int resultCode, Intent data){
        ...
        if(requestCode == Img_Request && resultCode == RESULT_OK && data != null){
            ...
            try {
                ...
                upload_other.setImageBitmap(photo);
            } catch (IOException e) {
                Toast.makeText(UploadOthers.this, e.toString(), Toast.LENGTH_SHORT).show();
                e.printStackTrace();
            }
        }
    ...
    private  class UploadImage extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            Toast.makeText(UploadOthers.this, "Image Uploaded", Toast.LENGTH_SHORT).show();
